...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        settings_button.setIcon(QIcon(os.path.join(os.path.dirname(__file__), "settings_icon.png")))
...
class SettingsWindow(QDialog):
    ...
    def save_settings(self):
        ...
        languages = [lang.strip() for lang in self.languages_edit.toPlainText().split('\n') if lang.strip()]
